/* NOVA TANKS v1.9.1 — Upgrade Dwell
...
if(!React||typeof React.createElement!=='function'||typeof React.useState!=='function'||typeof React.useEffect!=='function'){
  console.error('[NOVA v1.9.1] React hooks unavailable; upgrade dwell not installed');
  return;
}
var VERSION='1.9.1',CODENAME='Upgrade Dwell',DWELL_MS=500;
