...
wrap('game/engine',function(engine,require){
  ...
  var oldOrbs=Game.prototype.updateOrbs;if(oldOrbs)Game.prototype.updateOrbs=function(dt){var self=this,oldGain=this.gainXP,own=Object.prototype.hasOwnProperty.call(this,'gainXP');if(typeof oldGain!=='function')return oldOrbs.apply(this,arguments);this.gainXP=function(t,amt){var before=t&&Number(t.xp)||0,out=oldGain.apply(self,arguments);if(t&&t.isPlayer&&self.__lfState){var delta=Math.max(0,(Number(t.xp)||0)-before);self.__lfState.stats.playerNeutralXP+=delta;}return out;};try{return oldOrbs.apply(this,arguments);}finally{if(own)this.gainXP=oldGain;else delete this.gainXP;}};
