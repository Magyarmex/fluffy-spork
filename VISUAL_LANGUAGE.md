...
The regression suite scans production runtime files loaded after Signal Discipline. If a later runtime directly emits visuals but has no `NOVA_VISUAL_INTENT:` declaration, CI fails. This turns the visual language into a maintenance rule rather than a one-time cleanup.
